...
const { EPSILON, TERMINAL, iterate_over_rules } = require('./commons');
 ...
 *                      | pointer
 * */
function abstract_declarator(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function additive_expr(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                    | EPSILON
 * */
function additive_expr_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function and_expr(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *               | EPSILON
 * */
function and_expr_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function argument_expr_list(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                         | EPSILON
 * */
function argument_expr_list_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                  | conditional_expr
 * */
function assignment_expr(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                       | OR_ASSIGN
 * */
function assignment_operator(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function block_item_list(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                      | EPSILON
 * */
function block_item_list_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *              | declaration
 * */
function block_item(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *             | unary_expr
 * */
function cast_expr(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                 | '{' '}'
 * */
function compound_stmt(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                    | logical_or_expr
 * */
function conditional_expr(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function constant_expr(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function declaration(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function declaration_list(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                       | EPSILON
 * */
function declaration_list_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                          | function_specifier
 * */
function declaration_specifiers(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *              | direct_declarator
 * */
function declarator(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function designation(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function designator_list(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                     | EPSILON
 * */
function designator_list_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *              | '.' IDENTIFIER
 * */
function designator(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function direct_abstract_declarator(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                                 | EPSILON
 * */
function direct_abstract_declarator_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function direct_declarator(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                       | EPSILON
 * */
function direct_declarator_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                  | ENUM IDENTIFIER
 * */
function enum_specifier(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *             | IDENTIFIER
 * */
function enumerator(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function enumerator_list(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                     | EPSILON
 * */
function enumerator_list_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function equality_expr(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                    | EPSILON
 * */
function equality_expr_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function exclusive_or_expr(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                        | EPSILON
 * */
function exclusive_or_expr_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function expr(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
  new_node['title'] = 'expr';
  new_node['children'] = [];
 ...
 *           | EPSILON
 * */
function expr_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                   | expr ';'
 * */
function expression_stmt(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                         | declaration
 * */
function external_declaration_1(token_stream, arrow, node) {
  let child_1 = null;
...
function external_declaration_2(token_stream, arrow, node) {
  let child_1 = null;
  child_1 = declaration(token_stream, arrow);
  if (child_1) {
    node['children'].push(child_1);
...
function external_declaration(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
  new_node['title'] = 'external_declaration';
  new_node['children'] = [];
  let list_of_rules = [external_declaration_1, external_declaration_2];
  iterate_over_rules(token_stream, new_arrow, list_of_rules, new_node);
  if (new_node['children'].length > 0) {
    arrow['pointer'] = new_arrow['pointer'];
    return new_node;
 ...
 * */
function function_definition(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function function_specifier(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function identifier_list(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                     | EPSILON
 * */
function identifier_list_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function inclusive_or_expr(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                        | EPSILON
 * */
function inclusive_or_expr_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                   | declarator
 * */
function init_declarator(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function init_declarator_list(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                          | EPSILON
 * */
function init_declarator_list_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *               | '{' initializer_list ';' '}'
 * */
function initializer(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function initializer_list(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                       | EPSILON
 * */
function initializer_list_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function iteration_stmt(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *            | RETURN expr ';'
 * */
function jump_stmt(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                 | DEFAULT ':' stmt
 * */
function labeled_stmt(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function logical_and_expr(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                       | EPSILON
 * */
function logical_and_expr_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function logical_or_expr(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                      | EPSILON
 * */
function logical_or_expr_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function multiplicative_expr(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                          | EPSILON
 * */
function multiplicative_expr_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                        | declaration_specifiers
 * */
function parameter_declaration(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function parameter_list(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                     | EPSILON
 * */
function parameter_list_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                       | parameter_list
 * */
function parameter_type_list(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *           | '*'
 * */
function pointer(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                | '(' type_name ')' '{' initializer_list ',' '}' postfix_expr_p
 * */
function postfix_expr(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                  | EPSILON
 * */
function postfix_expr_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                | '(' expr ')'
 * */
function primary_expr(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function relational_expr(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                      | EPSILON
 * */
function relational_expr_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                  | SWITCH '(' expr ')' stmt
 * */
function selection_stmt(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function shift_expr(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                 | EPSILON
 * */
function shift_expr_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                            | type_qualifier
 * */
function specifier_qualifier_list(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *        | jump_stmt
 * */
function stmt(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
  new_node['title'] = 'stmt';
  new_node['children'] = [];
 ...
 *                           | REGISTER
 * */
function storage_class_specifier(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function struct_declaration(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function struct_declaration_list(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                             | EPSILON
 * */
function struct_declaration_list_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                     | declarator
 * */
function struct_declarator(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function struct_declarator_list(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                             | EPSILON
 * */
function struct_declarator_list_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                   | UNION
 * */
function struct_or_union(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function struct_or_union_specifier(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 * */
function translation_unit(token_stream, arrow) {
  let new_node = {},
    child_1 = null,
    child_2 = null;
  let new_arrow = clone(arrow);
 ...
 *                       | EPSILON
 * */
function translation_unit_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *             | IDENTIFIER
 * */
function type_name(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                  | RESTRICT
 * */
function type_qualifier(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *
 * */
function type_qualifier_list(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *
 * */
function type_qualifier_list_p(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *
 * */
function type_specifier(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *             | SIZEOF '(' type_name ')'
 * */
function unary_expr(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
 ...
 *                  | '!'
 * */
function unary_operator(token_stream, arrow) {
  let new_node = {};
  let new_arrow = clone(arrow);
